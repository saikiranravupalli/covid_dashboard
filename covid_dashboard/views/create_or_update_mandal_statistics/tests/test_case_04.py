"""
# TODO: Update or create mandal statistics with valid details creates daily statistics
"""
...
class TestCase04CreateOrUpdateMandalStatisticsAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase04CreateOrUpdateMandalStatisticsAPITestCase, self).\
