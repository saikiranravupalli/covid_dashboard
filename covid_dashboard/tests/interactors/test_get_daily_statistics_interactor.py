...
def test_given_invalid_admin_raises_exception():
    ...
    # Assert
    user_storage.is_user_admin.assert_called_once_with(user_id=invalid_user_admin)
...
def test_get_daily_statistics_with_valid_user_details_returns_statistics_dict(
    get_daily_statistics_response, get_daily_statistics_dtos):
